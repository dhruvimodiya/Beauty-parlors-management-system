...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM reg where rid ="+sessionid+"");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM reg where rid ="+sessionid+" LIMIT " + start + "," + limit);
...
<td><a href="updatecustomer.jsp?update=<%= rs.getString(1)%>" class="edit">Update</a></td>
